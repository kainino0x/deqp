...
class WebGLRenderContext : public glu::RenderContext
{
	public:
		...
		glu::ContextType getType() const { return m_type; }
		const glw::Functions& getFunctions() const { return m_functions; }
		const tcu::RenderTarget& getRenderTarget() const { return m_renderTarget; }
		void postIterate() {}
